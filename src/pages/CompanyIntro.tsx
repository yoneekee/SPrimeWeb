    ...
    <ERPLayout>
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <Card
          ...
          onClick={() => setNavigateTarget({ title: "デザインシステム", path: "/design-system" })}
        >
          <CardHeader className="pb-3">
          ...
          <CardContent>
            <div className="flex items-start gap-4 p-4 rounded-lg bg-secondary/30 border border-border/50">
              ...
              <div className="flex-1">
                <p className="text-sm font-semibold text-foreground mb-1">UIコンポーネントおよびスタイルガイド</p>
                <p className="text-xs text-muted-foreground leading-relaxed">
                  カラーパレット、タイポグラフィ、ボタン・バッジ・カードなどの共通UIコンポーネント、ステータスバッジの使用規則など、S-PRIME ERPで使用する全デザイン要素をまとめたガイドです。
                </p>
                <Badge variant="outline" className="mt-2 text-[10px] border-primary/30 text-primary">/design-system →</Badge>
              </div>
            </div>
          </CardContent>
        </Card>
