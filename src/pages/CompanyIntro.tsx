...
const accountCodes = [
  {
    ...
    name: "原材料",
    code: "1101",
    desc: "外部から購入した基礎部品および原材料",
  },
  {
    category: "資産",
    name: "半製品",
    code: "1102",
    desc: "組立中のモジュールや加工された中間部品",
  },
  {
    category: "資産",
    name: "完成品",
  ...
  },
  {
    ...
    name: "未着品",
    code: "1104",
    desc: "発注後まだ倉庫に到着していない輸送中資産",
  },
  {
    category: "資産",
    name: "積送品",
    code: "1105",
    desc: "顧客へ配送中だがまだ売上認識前の資産",
  },
  {
    category: "資産",
    name: "売掛金",
    code: "1106",
    desc: "製品販売後まだ回収していない債権",
  },
  {
    category: "負債",
    name: "買掛金",
    code: "2101",
    desc: "原材料入庫後まだ支払っていない債務",
  },
  {
    category: "負債",
    name: "未払金",
    code: "2102",
    desc: "一般経費や発注段階で発生する一時的債務",
  },
  {
    category: "収益",
    name: "売上高",
    code: "4101",
    desc: "装置販売およびサービス提供収益",
  },
  {
    category: "費用",
    name: "売上原価",
...
const techStack = [
  { icon: Code2, label: "Frontend", value: "TypeScript, React, React Query" },
  {
    icon: Server,
    label: "Backend",
    value: "C# (.NET Core), Entity Framework Core",
  },
...
const tableSchemas: Record<string, TableColumn[]> = {
  tran_history: [
    ...
    },
    {
      ...
      type: "INTEGER",
      constraint: "FK",
      desc: "起案者ID（Employees参照）",
    },
    {
      name: "status_code",
      type: "VARCHAR(10)",
      constraint: "FK",
      desc: "現在の伝票状態（Common_Codes参照）",
    },
    {
      name: "slip_type",
      type: "VARCHAR(10)",
      constraint: "NOT NULL",
      desc: "伝票区分（PRODUCTION：生産/購買、SHIPMENT：出庫）",
    },
    {
      name: "from_loc_id",
      type: "INTEGER",
    ...
    },
    {
      ...
      desc: "書類出力状況 0(請求書未出力) 1(請求書出力済)",
    },
    {
      name: "is_printed2",
      type: "INTEGER",
      constraint: "DEFAULT 2",
      desc: "書類出力状況 2(発注書未出力) 3(発注書出力済)",
    },
    {
      name: "partner_id",
      type: "INTEGER",
  ...
  stock_spec_history: [
    ...
    },
    {
      name: "slip_no",
      type: "VARCHAR(20)",
      constraint: "FK (slip_headers)",
      desc: "元伝票番号",
    },
    {
      name: "detail_id",
      type: "INTEGER",
      constraint: "FK (slip_details)",
      desc: "伝票明細行参照",
    },
    {
      name: "receive_date",
    ...
    },
    {
      ...
      type: "VARCHAR(30)",
      constraint: "-",
      desc: "入庫LOT番号（バッチ別追跡用）",
    },
    {
      name: "loc_id",
      type: "INTEGER",
      constraint: "FK (locations)",
      desc: "入庫拠点ID",
    },
    {
      name: "inspect_note",
  ...
  warehouse_mst: [
    { name: "loc_id", type: "SERIAL", constraint: "PK", desc: "拠点固有番号" },
    {
      ...
      type: "VARCHAR(50)",
      constraint: "NOT NULL",
      desc: "拠点名称（例：本社倉庫、渋谷店舗）",
    },
    {
      name: "loc_type",
      type: "VARCHAR(10)",
      constraint: "NOT NULL",
      desc: "拠点類型（FACTORY, STORE, TRANSIT, VENDOR）",
    },
    {
      name: "postal_code",
      type: "VARCHAR(10)",
  ...
  customer_mst: [
    ...
    },
    {
      ...
      type: "VARCHAR(10)",
      constraint: "NOT NULL",
      desc: "区分（SUPPLIER：仕入先、CUSTOMER：得意先、BOTH：兼用）",
    },
    {
      name: "postal_code",
      type: "VARCHAR(10)",
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-primary/5 via-primary/10 to-accent/5 border border-border p-8">
          ...
          <div className="relative z-10">
            <Badge
              variant="outline"
              className="mb-3 text-[10px] tracking-widest uppercase border-primary/30 text-primary"
            >
            ...
            <p className="text-sm text-muted-foreground max-w-2xl leading-relaxed">
              <strong>S</strong>emiconductor <strong>P</strong>recision{" "}
              <strong>R</strong>esource & <strong>I</strong>nventory{" "}
              <strong>M</strong>anagement <strong>E</strong>RP
            </p>
            <Separator className="my-4" />
            <p className="text-sm text-muted-foreground leading-relaxed max-w-3xl">
              半導体精密部品および装置製造業の特性を反映し、
              <strong className="text-foreground">
                原材料調達からBOM基盤の生産、最終製品出庫に至る全工程を統合管理
              </strong>
              するシステムです。
        ...
        >
          <CardHeader className="pb-3">
            <SectionTitle icon={Layers}>デザインシステム</SectionTitle>
          </CardHeader>
          <CardContent>
            <div className="flex items-start gap-4 p-4 rounded-lg bg-secondary/30 border border-border/50">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  カラーパレット、タイポグラフィ、ボタン・バッジ・カードなどの共通UIコンポーネント、ステータスバッジの使用規則など、S-PRIME
                  ERPで使用する全デザイン要素をまとめたガイドです。
                </p>
                <Badge
                  variant="outline"
            ...
            >
              <AccordionItem value="step1">
                ...
                <AccordionContent className="text-xs text-muted-foreground space-y-1.5 pl-8">
                  <p>
                    • <strong className="text-foreground">申請：</strong>{" "}
                    ログインユーザーが伝票作成（申請中）
                  </p>
                  <p>
                    • <strong className="text-foreground">承認：</strong>{" "}
                    指定された承認権限者が全員承認して次のステップへ進行
                  </p>
                  <p>
                    • <strong className="text-foreground">否認：</strong>{" "}
                    承認者のうち一人でも却下した場合、伝票終了
                  </p>
                  <p>
                    • <strong className="text-foreground">差戻：</strong>{" "}
                    承認完了後、発注前に製造担当者が修正依頼
                  </p>
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="step2">
                ...
                <AccordionContent className="text-xs text-muted-foreground space-y-1.5 pl-8">
                  <p>
                    • <strong className="text-foreground">見積：</strong>{" "}
                    予定在庫増加（入庫予定数量確保）
                  </p>
                  <p>
                    • <strong className="text-foreground">発注：</strong> [借方]
                    未着品 / [貸方] 未払金
                  </p>
                  <p>
                    • <strong className="text-foreground">分納：</strong>{" "}
                    ワークフロー履歴に記録累積
                  </p>
                  <p>
                    • <strong className="text-foreground">入庫：</strong> （累計
                    == 発注量）の場合 [借] 原材料 / [貸] 買掛金 確定
                  </p>
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="step3">
                ...
                <AccordionContent className="text-xs text-muted-foreground space-y-1.5 pl-8">
                  <p>
                    • <strong className="text-foreground">検収：</strong>{" "}
                    予定在庫差引、実在庫の増減反映
                  </p>
                  <p>
                    • 受払履歴テーブルに最終「入庫完了」トランザクション記録
                  </p>
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="step4">
                ...
                <AccordionContent className="text-xs text-muted-foreground pl-8">
                  <p>
                    検収終了後、財務諸表に反映および各種書類（請求書、発注書）の出力が可能
                  </p>
                </AccordionContent>
              </AccordionItem>
            </Accordion>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-secondary/50">
                    <TableHead className="text-[11px] font-semibold w-20">
                      区分
                    </TableHead>
                    <TableHead className="text-[11px] font-semibold w-24">
                      コード
                    </TableHead>
                    <TableHead className="text-[11px] font-semibold w-32">
                      ステータス (EN)
                    </TableHead>
                    <TableHead className="text-[11px] font-semibold w-32">
                      ステータス (JP)
                ...
                <TableBody>
                  {statusCodes.map((s) => (
                    <TableRow key={s.code}>
                      ...
                      <TableCell className="text-[11px] font-mono font-semibold text-primary">
                        {s.code}
                      </TableCell>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <div className="p-4 rounded-lg border border-border/50 bg-secondary/30">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                在庫差引時に悲観的ロック（Pessimistic
                Lock）およびitem_idソート順によるロック取得でデッドロック防止とデータ精度を確保
              </p>
            </div>
              ...
              {[
                {
                  id: "8.1",
                  title: "生産出庫伝票一覧",
                  desc: "製造購買および出庫に関する全伝票を横断的に検索・照会",
                  path: "/production/slips",
                },
                {
                  id: "8.2",
                  title: "製品生産および実行",
                  desc: "生産起案～最終検収までの全ライフサイクル管理",
                  path: "/production/execution",
                },
                {
                  id: "8.3",
                  title: "出庫および在庫調整",
                  desc: "出庫申請～売上確定/在庫調整のライフサイクル管理",
                  path: "/production/shipping",
                },
                {
                  id: "8.4",
                  title: "財務諸表照会",
                  desc: "B/S、P/L照会およびPDF出力",
                  path: "/documents/finance",
                },
                {
                  id: "8.5",
                  title: "BOM生産伝票",
                  desc: "BOM基盤の生産伝票照会および出力",
                  path: "/documents/bom",
                },
                {
                  id: "8.6",
                  title: "請求書・発注書",
                  desc: "発注書（PO）、請求書（Invoice）照会およびPDF出力",
                ...
                <TableBody>
                  {tableSchemas[selectedTable].map((col) => (
                    <TableRow key={col.name}>
                      <TableCell className="text-[11px] font-mono text-primary font-medium">
                        {col.name}
                      </TableCell>
      ...
      >
        <DialogContent className="sm:max-w-sm">
          ...
          <p className="text-xs text-muted-foreground">
            <strong className="text-foreground">{navigateTarget?.title}</strong>{" "}
            画面に遷移します。
          </p>
          <DialogFooter className="gap-2 sm:gap-0">
            ...
            <Button
              size="sm"
              onClick={() => {
                if (navigateTarget) navigate(navigateTarget.path);
